...
/**
 * This class used for Wrapper Class.A Partial Keyword Driven Framework
 * Core Engine
 * Entire Logic should be in libraries
 * Test Higher Level->Page->Utility(Wrapper)Lower Level
 * Driver is in Lower Level inside wrapper classes
 * Make changes in Lower Level
 * Highest level is used to call the methods
 * For Coding Standard:https://martinfowler.com/bliki/PageObject.html
 */
public class ElementUtil {
	...
	public void doSendKeys(By locator, String... value) {
		try {
			...
			getElement(locator).sendKeys(Keys.CLEAR, Keys.BACK_SPACE);
